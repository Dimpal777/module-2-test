...
// Image 2 Function : Display  info  form
...
function diceClick() {
    ...
    if (RemainingDiceClick === 0) {
        ...
        document.getElementById('score').innerText = totalScore;
        if (totalScore > 10) {
            alert(`Yehhh Congratulations 🎉🎉🎊🎊😍❤️!!! Your total score is ${totalScore} which is greater than 10. Click on next Image to avail your coupon code.`);
